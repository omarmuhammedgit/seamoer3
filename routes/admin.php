...
Route::post('Customer-addCustomerAjax',[CustomerController::class,'addCustomerAjax'])->name('Customer-addCustomerAjax');
Route::post('Customer-reloadaddCustomerAjax',[CustomerController::class,'reloadaddCustomerAjax'])->name('Customer-reloadaddCustomerAjax');
...
// Route end Report
// Route start Admin
Route::get('user.index',[AdminUserControler::class,'index'])->name('user.index');
Route::get('user.create',[AdminUserControler::class,'create'])->name('user.create');
Route::post('user.store',[AdminUserControler::class,'store'])->name('user.store');
Route::get('user.edit/{id}',[AdminUserControler::class,'edit'])->name('user.edit');
Route::post('user.update/{id}',[AdminUserControler::class,'update'])->name('user.update');
//Route end Admin
...
Route::post('Sale-menu-storeandaddrequest',[SaleController::class,'storeandaddrequest'])->name('Sale-menu-storeandaddrequest');
Route::post('Sale-menu-storeSecandrequesr',[SaleController::class,'storeSecandrequesr'])->name('Sale-menu-storeSecandrequesr');
Route::get('Sale-menu-getViewAddrequest/{invoice_id}',[SaleController::class,'getViewAddrequest'])->name('Sale-menu-getViewAddrequest');
...
Route::group(['middleware'=>'guest:admin'],function(){
    Route::get('login',[AdminUserControler::class,'getlogin'])->name('login');
