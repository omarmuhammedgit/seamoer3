...
@endif
    ...
    <div class="row row-sm">
        <a class="btn ripple btn-info"  href="{{route('Seamoer-create.create')}}" style="margin-right: 2%">اضافة</a>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                  <button class="btn btn-warning btn-block"> <a class="dropdown-item" href="edit-Seamoer/{{$seamoer->id}}">تعديل</a></button>
                                                   <button class="btn btn-info btn-block"> <a class="dropdown-item " href="Seamoer-checkup/{{$seamoer->id}}"> فحص</a></button>
   ...
   <div class="modal" id="modaldemo9">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <form action="{{route('Seamoer-delete')}}" method="post">
                {{-- {{method_field('delete')}} --}}
                {{csrf_field()}}
