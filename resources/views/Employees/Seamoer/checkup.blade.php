                            ...
                            <tbody>
                                ...
                                @foreach ($info_seamoers as $info_seamoer)
                                    <tr>
                                        ...
                                        <td>{{ $info_seamoer->design->name_design }}</td>
                                        <td>{{ $info_seamoer->fabric->type_fabrice }}</td>
                                        <td>{{ $info_seamoer->fabric->color_fabrice }}</td>
                                        <td>{{ $info_seamoer->tradeMark->name_trade_mark}}</td>
