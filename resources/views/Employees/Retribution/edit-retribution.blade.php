                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                ...
                                <input type="number" name="recordnumber"  value="{{$retribution->recordnumber}}" placeholder="رقم السجل التجاري" required>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                ...
                                <input type="number" name="phone" placeholder="رقم الجوال"  value="{{$retribution->phone}}" required>
                            </div>
                            <div class="col-lg-3">
                                <label><span>رقم الجوال المنشاة</span></label>
                                <input type="number" name="facilitynumber" placeholder="رقم الجوال المنشاة"  value="{{$retribution->facilitynumber}}">
                            </div>
                            <div class="col-lg-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                ...
                                <input type="number" name="accountnumber" placeholder="رقم البنك"  value="{{$retribution->accountnumber}}">
                            </div>
                            <div class="col-lg-3">
