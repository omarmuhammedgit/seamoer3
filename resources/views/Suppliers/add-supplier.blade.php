                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                ...
                                <input type="number" name="contactId" placeholder="معرف الاتصال" required >
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                ...
                                <input type="number" name="tax_number" placeholder="الرقم الضريبي">
                            </div>
                            <div class="col-lg-3">
                                <label><span>الرصيد افتتاخي</span></label>
                                <input type="number" name="initial_balance" placeholder="الرصيد الافتتاحي">
                            </div>
                            <div class="col-lg-3">
                                <label><span>فترةالدفع</span></label>
                                <input type="number" name="payment_period" placeholder="فترة الدفع">
