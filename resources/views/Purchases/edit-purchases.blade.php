                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-lg-3">
                            ...
                            <input class="form-control" type="hidden" value="{{ $purchase->id }}" name="id">
                            @php
                                $suppliers = \App\Models\Supplier::all();
                            @endphp

                            <label for="">المورد:*</label><br>
                        ...
                        <div class="col-lg-3">
                            ...
                            <input class="form-control" type="text" name="Reference_number" placeholder="رقم المرجعي"
                        ...
                        <div class="col-lg-3">
                            ...
                            <input class="form-control" type="number" name="payment_period1" placeholder="فترة الدفع"
                                value="{{ $purchase->payment_period1 }}">
                        </div>
                        <div class="col-lg-3">
                            فترة الدفع <br>
                                ...
                                <table class="table text-md-nowrap" id="example1" data-page-length="50">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($products as $product)
                                            <tr>
                                                <td>
                                                    <input class="form-control" type="checkbox" name="product_id"
                                                        value="{{ $product->id }}">
                                                </td>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        ...
                        <input class="form-control" type="text" name="value_discount" placeholder=" قيمة الخصم"
                            value="{{ $purchase->value_discount }}">
                    </div>
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-3"><br>
                        ...
                        <input class="form-control" type="text" name="tax_purchase"
                            value="{{ $purchase->tax_purchase }}" placeholder="ضريبة المشتريات">
                    </div>
                    <div class="col-lg-3"><br>
                        <label><span>ملاحظات اضافية</span></label><br>
                        <textarea class="form-control" name="comments_add" id="" cols="100" rows="2">{{ $purchase->comments_add }}</textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        ...
                        <input class="form-control" type="date" name="datePayment"
                            value="{{ $purchase->datePayment }}">
                    </div>
                    <div class="col-lg-3">
                        <label><span>طريقة الدفع</span></label><br>
                        <select class="form-control" name="payment_method" id="">{{ $purchase->payment_method }}
                    ...
                    <div class="col-lg-3"><br>
                        ...
                        <textarea  class="form-control" name="payment_comments" id="" cols="100" rows="3">{{ $purchase->payment_comments }}</textarea>
                        {{-- <input class="form-control" type="text" name="recordnumber"  required style="width: 60%"> --}}
                    </div>
