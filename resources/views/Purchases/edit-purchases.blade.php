...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">المشتريات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تعديل مشتريات</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><label for="">رقم المرجعي</label><br>
                                    <input type="text" name="Reference_number" placeholder="رقم المرجعي" value="{{$purchase->Reference_number}}">
                                </td>
                                @php
                                    $date=date('d/m/Y');
                                @endphp
                                <td><label for="">تاريخ الشراء</label><br>
                                    <input type="date" name="data_purchase" value="{{$purchase->data_purchase}}">
                                </td>
                                <td><label for="">حالة الشراء</label><br>
                                    <select name="status_purchase">
                                        <option value="{{$purchase->status_purchase}}">{{$purchase->status_purchase}}</option>
                            ...
                            <tr>
                                <td><label for="">العنوان</label><br>
                                    <input type="text" name="address" placeholder=" العنوان" value="{{$purchase->address}}">
                                </td>
                                <td><label for="">الفرعي:*</label><br>
                                    <input type="text" name="sub" placeholder="الفرع" value="{{$purchase->sub}}">
                                </td>
                                <td><label for="">فترة الدفع</label><br>
                                    <input type="number" name="payment_period1" placeholder="فترة الدفع" value="{{$purchase->payment_period1}}">
                                </td>
                                <td><br>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <input type="text" name="value_discount" placeholder=" قيمة الخصم" value="{{$purchase->value_discount}}">
                        </div>
                        <div class="col-lg-3">
                            <label><span>الخصم</span></label><br>
                            <input type="text" name="discount" placeholder="الخصم" value="{{$purchase->value_discount}}">
                        </div><br>
                        <div class="col-lg-3">
                        ...
                        <div class="col-lg-3"><br>
                            <label><span>ضريبة المشتريات</span></label><br>
                            <input type="text" name="tax_purchase"  value="{{$purchase->tax_purchase}}" placeholder="ضريبة المشتريات">
                        </div>
                        <div class="col-lg-3"><br>
                            <label><span>ملاحظات اضافية</span></label><br>
                            <textarea name="comments_add" id="" cols="100" rows="2">{{$purchase->comments_add}}</textarea>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            ...
                            <input type="text" name="amount" placeholder="المبلغ" value="{{$purchase->amount}}">
                        </div>
                        @php
                        ...
                        <div class="col-lg-3">
                            ...
                            <input type="date" name="datePayment" value="{{$purchase->datePayment}}" >
                        </div>
                        <div class="col-lg-3">
                            <label><span>طريقة الدفع</span></label><br>
                            <select name="payment_method" id="">{{$purchase->payment_method}}
                        ...
                        <div class="col-lg-3">
                            ...
                            <input type="text" name="account" placeholder="الحساب" value="{{$purchase->account}}">
                        </div><br>
                        <div class="col-lg-3"><br>
                            <label><span>ملاحظات الدفع</span></label><br>
                            <textarea name="payment_comments" id="" cols="100" rows="3">{{$purchase->payment_comments}}</textarea>
                            {{-- <input type="text" name="recordnumber"  required style="width: 60%"> --}}
                        </div>
