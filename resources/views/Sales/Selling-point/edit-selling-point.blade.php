                            ...
                            <div id="idhight">
                                <center>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <select class="form-control" name="name_design" id="">
                                                    <option value="{{ $info_size_customer->design }}">
                                                        {{ $info_size_customer->design }}</option>
                                    ...
                                    <select class="form-control" name="name_section" id="name_section">
                                        <option value="{{ $info_size_customer->section }}">
                                            {{ $info_size_customer->section }}</option>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <select class="form-control" name="type_fabrice" id="">
                                                    <option value="{{ $info_size_customer->fabrice }}">
                                                        {{ $info_size_customer->fabrice }}</option>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <select class="form-control" name="color_fabrice" id="">
                                                    <option value="{{ $info_size_customer->color_fabrice }}">
                                                        {{ $info_size_customer->color_fabrice }}</option>
                                                    @foreach ($fabrices as $fabrice)
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <select class="form-control" name="name_trade_mark" id="">
                                                    <option value="{{ $info_size_customer->tradeMark }}">
                                                        {{ $info_size_customer->tradeMark }}</option>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <select class="form-control" name="retribution" id="">
                                                    <option value="{{ $info_size_customer->retribution->id }}">
                                                        {{ $info_size_customer->retribution->name }}</option>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <select class="form-control" name="seamoer" id="">
                                                    <option value="{{ $info_size_customer->seamoer->id }}">
                                                        {{ $info_size_customer->seamoer->name }}</option>
                                    ...
                                    <input class="form-control" type="number" name="receivedamount" id="receivedamount"
                                        ...
                                        value="{{ $info_size_customer->receivedamount }}">
                                    <label for="">المبلغ المتبقي</label>
                                    <input class="form-control" type="number" name="remainingamount"
                                        id="remainingamount" readonly value="{{ $info_size_customer->remainingamount }}">
                                    <label for="">نوع الدفع</label>
                                    <select class="form-control" name="payment" id="">
                                        <option value="{{ $info_size_customer->payment }}">
                                            {{ $info_size_customer->payment }}</option>
