...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
            ...
            <button class="btn ripple btn-info" type="button" style="margin-bottom:10%;margin-right:45%"> <a href="{{ route('Customer.index') }}" style="color: white"> رجوع</a></button>
        </div>
